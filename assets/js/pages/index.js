(function () {
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        // --- Calculators ---
        function setupCalculator(blockSelector, dataList, stateKey, syncWidgetSelector, percentKey) {
        ...
        setupCalculator("#calculator-reach", packages.IREACH, "reachPrice", "#summary-reach", "reachPercent");
        setupCalculator("#calculator-impressions", packages.IIMPRESSIONS, "impressionsPrice", "#summary-impressions");
        setupCalculator("#calculator-saves", packages.ISAVES, "savesPrice", "#summary-saves");
